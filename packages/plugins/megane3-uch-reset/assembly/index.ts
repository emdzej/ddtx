/**
 * Megane / Scenic III UCH reset.
 *
 * Port of `plugins/megane3_uch_reset.py`. Reads the module's state, reports it, then performs
...
function next(result: string): i32 {
  switch (step) {
    ...
    case 1:
      return read('Read_A_AC_General_Identifiers_Learning_Status_(bits)_BCM_Input/Output');
    case 2:
      return log('Module state read.');
    case 3:
      return write('SR_RESERVED VSC 1', '{}');
    case 4:
